...
- 📖 **Curated Architecture Handbooks**:
  1. **KDE Plasma 6 (Wayland) KWin & Effects**: Window decorations, Klassy border styling, background blur, and custom KWin window rules (e.g. for Glava audio visualizer).
...
- 🎨 **Dual Interface**:
  - **Textual TUI**: Modern terminal user interface with interactive categories, search bar, and scrollable markdown viewer.
  - **CLI Core**: Fast command-line interface for scripts, headless environments, and automated exports.
